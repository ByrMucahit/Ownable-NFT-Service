                ...
                <div className={styles.row}>
                    ...
                    <div className={styles.photoExhibition}>
                        ...
                        <div className={styles.photos}>
                            <Photo className={styles.imgExhibit}/>
                            <Photo className={styles.imgExhibit} src="https://firebasestorage.googleapis.com/v0/b/receiptcoin-receiptchain-de560.appspot.com/o/website%2Fchicadees%2Fcashcows.png?alt=media&token=60ef4aa7-42c9-47de-82a6-b719953749c3"/>
                        </div>
                        {/* Owner Of Photos */}
